...
public class CommandTestUtil {
    ...
    public static final String VALID_LASTVISITDATE_AMY = "2025-01-01";
    public static final String VALID_LASTVISITDATE_BOB = "2025-01-02";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final String VALID_MEDICATION_AMY = "paracetamol";
    public static final String VALID_MEDICATION_BOB = "steroids";
    ...
    public static final String LAST_VISIT_AMY = " " + PREFIX_DATE + VALID_LASTVISITDATE_AMY;
    public static final String LAST_VISIT_BOB = " " + PREFIX_DATE + VALID_LASTVISITDATE_BOB;
    ...
    public static final String INVALID_VISIT_DESC = " " + PREFIX_DATE; // empty string not allowed for last visit
